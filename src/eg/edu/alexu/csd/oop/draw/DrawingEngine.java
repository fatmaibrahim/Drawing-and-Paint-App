...
public interface DrawingEngine {
	/* redraw all shapes on the canvas */ public void refresh(java.awt.Graphics canvas);
	...
	/* return the created shapes objects */ public Shape[] getShapes();
	...
	/*
	 * limited to 20 steps. You consider these actions in * undo & redo:
